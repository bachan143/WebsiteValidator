...
public class NewsArticlesTestAbendblatt {

    private SortableURL sUrl;
    private Document doc;

    public NewsArticlesTestAbendblatt(SortableURL url) {
        this.sUrl = url;
    }

    @Parameterized.Parameters
    public static List<SortableURL> URLS() {
        //Sort urls and only get the first 50
        List<SortableURL> sortableURLS = XMLUtility.getURLsFromXML("https://www.abendblatt.de/sitemaps/news.xml");
